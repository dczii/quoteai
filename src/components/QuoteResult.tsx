              ...
              <div className='space-y-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                  <div className='p-6 rounded-2xl bg-brand-badge border border-brand-border'>
                    <div className='text-brand-accent font-bold text-sm uppercase tracking-wider mb-1'>
                      Total Estimate
                    </div>
                  ...
                  <div className='p-6 rounded-2xl bg-brand-surface border border-brand-border'>
                    <div className='text-brand-primary font-bold text-sm uppercase tracking-wider mb-1 opacity-60'>
                      Team Size
                    </div>
                    <div className='text-3xl font-bold text-brand-primary'>
                      {quote.team.reduce((acc, curr) => acc + curr.count, 0)} Experts
                    </div>
                  </div>
                  <div className='p-6 rounded-2xl bg-brand-surface border border-brand-border'>
                    <div className='text-brand-primary font-bold text-sm uppercase tracking-wider mb-1 opacity-60'>
                ...
                <div className='pt-8'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    {quote.deliverables.slice(0, 4).map((d, i) => (
                      <div
                        key={i}
                        className='flex items-start gap-3 p-4 rounded-xl border border-brand-border'
                      >
                  ...
                  <table className='w-full text-left border-collapse'>
                    <thead className='bg-brand-badge'>
                      <tr>
                        ...
                        <th className='px-6 py-4 text-sm font-bold text-brand-primary'>
                          Seniority
                        </th>
                        <th className='px-6 py-4 text-sm font-bold text-brand-primary'>Count</th>
                        <th className='px-6 py-4 text-sm font-bold text-brand-primary text-right'>
                          Hourly Rate
                        </th>
                        <th className='px-6 py-4 text-sm font-bold text-brand-primary text-right'>
                          Monthly
              ...
              <div className='space-y-8'>
                ...
                <div className='space-y-6'>
                  {quote.timeline.map((phase, i) => (
                    <div
                      key={i}
                      className='relative pl-8 border-l-2 border-brand-border pb-8 last:pb-0'
                    >
              ...
              <div className='space-y-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  {quote.deliverables.map((group, i) => (
                    <div
                      key={i}
                      className='p-6 rounded-2xl border border-brand-border bg-brand-badge/20'
                    >
              ...
              <div className='space-y-8'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                  {quote.techStack.map((stack, i) => (
                    <div
                      key={i}
                      className='p-6 rounded-2xl border border-brand-border bg-brand-surface'
                    >
                      <div className='text-sm font-bold text-brand-accent uppercase tracking-wider mb-4'>
                        {stack.category}
                      </div>
                      <div className='flex flex-wrap gap-2'>
                        {stack.technologies.map((tech, j) => (
                          <span
                            key={j}
                            className='px-3 py-1.5 rounded-lg bg-brand-badge text-brand-primary text-sm font-medium'
                          >
                            {tech}
                          </span>
                        ))}
              ...
              <div className='space-y-8'>
                ...
                <div className='space-y-4'>
                  {quote.riskAssessment.map((risk, i) => (
                    <div
                      key={i}
                      className='p-6 rounded-2xl border border-brand-border bg-brand-surface flex flex-col md:flex-row gap-6'
                    >
                      ...
                      <div className='md:w-2/3'>
                        <div className='text-sm font-bold text-muted uppercase tracking-wider mb-1'>
                          Mitigation Strategy
                        </div>
